...
const sidebars = {
  // The sidebar ID must match the one used in docusaurus.config.js ('tutorialSidebar' was old, 'kubernetesSidebar' is new)
  kubernetesSidebar: [
    {
      type: "category",
    ...
    },
    {
      type: "category",
      label:
        "Kubernetes - Workloads, Services, Namespaces & Imperative Commands",
      collapsed: false,
      items: [
    ...
    },
    {
      ...
      collapsed: false,
      items: ["crds-operators/crds", "crds-operators/operators"],
    },
    {
      type: "category",
    ...
    },
    {
      ...
      collapsed: false,
      items: ["networking/network-policies", "networking/dns-coredns"],
    },
    {
      type: "category",
      label: "Kubernetes - Ingress & Gateway API",
      collapsed: false,
      items: ["ingress-gateway/ingress", "ingress-gateway/gateway-api"],
    },
  ],
};
